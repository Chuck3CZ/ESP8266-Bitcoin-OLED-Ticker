...
void setup()   {
  ...
  display.setCursor(0, 0);               //pozice číslo 1
  display.println("  BITCOIN   TICKER"); //nadpis
  display.println();                     //mezera(případně vyzkoušet"\n")
  display.setTextSize(1);                //velikost textu 2
  display.setCursor(2, 24);              //pozice číslo 2
  display.println("88888");              //tisk textu
  display.display();                     //funkce zapsat do displaye
  delay(2000);                           //čekat 2s 
  display.clearDisplay();                //vyčisti display pro další funkci
